...
type DocumentJsonDependencies = {
  buildNodeSendableData: () => Record<string, string[]>
  refreshCounters: () => void
}

export function createDocumentJsonUseCases(
  context: EditorDocumentContext,
  dependencies: DocumentJsonDependencies,
) {
  ...
  function serializeDocument(): EditorDocumentDto {
  ...
  function resetDocument(): void {
    ...
    context.comments.value = defaults.comments
    context.jsonError.value = null
    dependencies.refreshCounters()
    syncJsonFromState()
  }
